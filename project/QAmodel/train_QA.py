...
if __name__ == "__main__":
    ...
    df_train.to_csv("results/train_predictions.csv", index=False)

    df_val = pd.DataFrame({'true_labels': val_true_labels, 'pred_labels': val_preds, 'pred_texts': val_pred_texts})
    df_val.to_csv("results/val_predictions.csv", index=False)
...
plt.ylabel('Loss')
plt.savefig(f'results/train_loss_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('Loss')
plt.savefig(f'results/val_loss_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('Loss')
plt.savefig(f'results/test_loss_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.savefig(f'results/train_exact_match_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('Exact Match')
plt.savefig(f'results/val_exact_match_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('Exact Match')
plt.savefig(f'results/test_exact_match_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('F1 Score')
plt.savefig(f'results/train_f1_score_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('F1 Score')
plt.savefig(f'results/val_f1_score_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
...
plt.xlabel('Iterations')
plt.ylabel('F1 Score')
plt.savefig(f'results/test_f1_score_plot_QA_{num_epochs}_{lr}.png')
plt.show()
plt.close()
