...
This model was trained by kmiyazaki using librspeech recipe in [espnet](https://github.com/espnet/espnet/).
...
```bash
cd espnet
git checkout 617189d2d7e060bbcf670ab54b88776333b5137e
pip install -e .
cd egs2/librispeech/asr1
./run.sh --skip_data_prep false --skip_train true --download_model espnet/kmiyazaki_librispeech_asr_s4_decoder
```
...
```
config: conf/tuning/train_asr_s4_decoder.yaml
print_config: false
log_level: INFO
dry_run: false
iterator_type: sequence
output_dir: exp/asr_train_asr_s4_decoder_raw_en_bpe5000_sp
ngpu: 1
seed: 0
num_workers: 4
num_att_plot: 3
