...
# lambdaofgod/query-titles-nbow-nbow-mnrl
...
model = SentenceTransformer('lambdaofgod/query-titles-nbow-nbow-mnrl')
...
For an automated evaluation of this model, see the *Sentence Embeddings Benchmark*: [https://seb.sbert.net](https://seb.sbert.net?model_name=lambdaofgod/query-titles-nbow-nbow-mnrl)
