...
# ONNX export of Adapter `AdapterHub/bert-base-uncased-pf-squad` for bert-base-uncased
## Conversion of [AdapterHub/bert-base-uncased-pf-squad](https://huggingface.co/AdapterHub/bert-base-uncased-pf-squad) for UKP SQuARE
