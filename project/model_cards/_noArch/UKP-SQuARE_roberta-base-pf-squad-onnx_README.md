...
# ONNX export of Adapter `AdapterHub/roberta-base-pf-squad` for roberta-base
## Conversion of [AdapterHub/roberta-base-pf-squad](https://huggingface.co/AdapterHub/roberta-base-pf-squad) for UKP SQuARE
