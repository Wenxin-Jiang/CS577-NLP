...
python -m utils.load_from_hub --algo dqn --env BreakoutNoFrameskip-v4 -orga bothrajat -f logs/
...
python -m utils.push_to_hub --algo dqn --env BreakoutNoFrameskip-v4 -f logs/ -orga bothrajat
```
