...
# ONNX export of Adapter `AdapterHub/bert-base-uncased-pf-newsqa` for bert-base-uncased
## Conversion of [AdapterHub/bert-base-uncased-pf-newsqa](https://huggingface.co/AdapterHub/bert-base-uncased-pf-newsqa) for UKP SQuARE


## Usage
```python
onnx_path = hf_hub_download(repo_id='UKP-SQuARE/bert-base-uncased-pf-newsqa-onnx', filename='model.onnx') # or model_quant.onnx for quantization
...
tokenizer = AutoTokenizer.from_pretrained('UKP-SQuARE/bert-base-uncased-pf-newsqa-onnx')
