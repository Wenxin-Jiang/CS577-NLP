...
python -m rl_zoo3.load_from_hub --algo dqn --env BeamRiderNoFrameskip-v4 -orga RajMoodley -f logs/
...
```
python -m rl_zoo3.load_from_hub --algo dqn --env BeamRiderNoFrameskip-v4 -orga RajMoodley -f logs/
rl_zoo3 enjoy --algo dqn --env BeamRiderNoFrameskip-v4  -f logs/
```
...
python -m rl_zoo3.push_to_hub --algo dqn --env BeamRiderNoFrameskip-v4 -f logs/ -orga RajMoodley
```
