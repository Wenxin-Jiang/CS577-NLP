...
model-index:
- name: keremberke/yolov5s-aerial-sheep
  results:
  - task:
    ...
    metrics:
      - type: precision  # since mAP@0.5 is not available on hf.co/metrics
        value: 0.9651314172419881  # min: 0.0 - max: 1.0
        name: mAP@0.5
---

<div align="center">
  <img width="640" alt="keremberke/yolov5s-aerial-sheep" src="https://huggingface.co/keremberke/yolov5s-aerial-sheep/resolve/main/sample_visuals.jpg">
</div>
