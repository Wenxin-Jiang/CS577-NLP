...
This model was trained on a dataset of 120 high-quality universe images.
...
# Load generator
generator = load_generator("huggan/fastgan-few-shot-universe")
...
[few-shot-universe](https://huggingface.co/datasets/huggan/few-shot-universe)
