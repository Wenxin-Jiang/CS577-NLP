...
```bash
cd espnet
git checkout ef3ce328551c12c03284defc757f42df47c46170
pip install -e .
cd egs2/swbd/asr1
./run.sh --skip_data_prep false --skip_train true --download_model pyf98/swbd_conformer
```
...
```
config: conf/tuning/train_asr_conformer_e12_size256_linear2048.yaml
print_config: false
log_level: INFO
dry_run: false
iterator_type: sequence
output_dir: exp/asr_train_asr_conformer_e12_size256_linear2048_raw_en_bpe2000_sp
ngpu: 1
seed: 2022
num_workers: 4
num_att_plot: 3
