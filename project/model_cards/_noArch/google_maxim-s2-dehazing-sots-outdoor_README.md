...
# MAXIM pre-trained on RESIDE-Outdoor for image dehazing 
...
As per the [table](https://github.com/google-research/maxim#results-and-pre-trained-models), the model achieves a PSNR of 34.19 and an SSIM of 0.985. 
