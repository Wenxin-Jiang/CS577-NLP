...
python enjoy.py --algo dqn --env RoadRunnerNoFrameskip-v4  -f logs/
```

## Training (with the RL Zoo)
```
python train.py --algo dqn --env RoadRunnerNoFrameskip-v4 -f logs/
# Upload the model and generate video (when possible)
python -m rl_zoo3.push_to_hub --algo dqn --env RoadRunnerNoFrameskip-v4 -f logs/ -orga sb3
```
