...
For an automated evaluation of this model, see the *Sentence Embeddings Benchmark*: [https://seb.sbert.net](https://seb.sbert.net?model_name=lambdaofgod/document_nbow_embedder)
...
SentenceTransformer(
  (0): WordEmbeddings(
    (emb_layer): Embedding(84046, 200)
  )
  (1): WordWeights(
    (emb_layer): Embedding(84046, 1)
  )
