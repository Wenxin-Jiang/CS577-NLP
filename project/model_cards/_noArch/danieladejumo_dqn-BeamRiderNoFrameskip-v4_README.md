...
python -m utils.load_from_hub --algo dqn --env BeamRiderNoFrameskip-v4 -orga danieladejumo -f logs/
...
python -m utils.push_to_hub --algo dqn --env BeamRiderNoFrameskip-v4 -f logs/ -orga danieladejumo
```
