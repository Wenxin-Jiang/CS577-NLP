...
- text-to-image
---
### ldr on Stable Diffusion via Dreambooth trained on the [fast-DreamBooth.ipynb by TheLastBen](https://colab.research.google.com/github/TheLastBen/fast-stable-diffusion/blob/main/fast-DreamBooth.ipynb) notebook
#### Model by CiroN2022
This your the Stable Diffusion model fine-tuned the ldr concept taught to Stable Diffusion with Dreambooth.
It can be used by modifying the `instance_prompt(s)`: **ldr**
...
ldr
![ldr 0](https://huggingface.co/CiroN2022/ldr/resolve/main/concept_images/ldr_(2).jpg)
