...
# ONNX export of Adapter `AdapterHub/roberta-base-pf-squad_v2` for roberta-base
## Conversion of [AdapterHub/roberta-base-pf-squad_v2](https://huggingface.co/AdapterHub/roberta-base-pf-squad_v2) for UKP SQuARE


## Usage
```python
onnx_path = hf_hub_download(repo_id='UKP-SQuARE/roberta-base-pf-squad_v2-onnx', filename='model.onnx') # or model_quant.onnx for quantization
