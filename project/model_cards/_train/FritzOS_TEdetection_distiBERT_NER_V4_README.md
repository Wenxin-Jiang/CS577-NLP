...
model-index:
- name: TEdetection_distiBERT_NER_V4
  results: []
---
...
This model is a fine-tuned version of [FritzOS/TEdetection_distiBERT_mLM_V2_shuffleplus3](https://huggingface.co/FritzOS/TEdetection_distiBERT_mLM_V2_shuffleplus3) on an unknown dataset.
