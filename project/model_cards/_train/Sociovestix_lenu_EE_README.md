...
- name: Sociovestix/lenu_EE
  ...
  - task:
    ...
    metrics:
    - type: f1
      value: 0.9952188304523722
      name: f1
    - type: f1
      value: 0.7099969646537327
      name: f1 macro
      args:
        average: macro
widget:
- text: "Fookus Arendus OÜ"
- text: "aktsiaselts Terastehnika"
- text: "Compensa Vienna Insurance Group, ADB Eesti filiaal"
- text: "Flader UÜ"
- text: "mittetulundusuhing Eesti Liikluskindlustuse Fond"
- text: "Sihtasutus Eesti Muusika- ja Teatriakadeemia Fond"
- text: "Põllumeeste ühistu KEVILI"
- text: "Tauliste Group OÜ"
- text: "TÜ Interactive communication"
- text: "Natalja Temnikova"
---

# LENU - Legal Entity Name Understanding for Estonia

A Bert (multilingual uncased) model fine-tuned on estonian legal entity names (jurisdiction EE) from the Global [Legal Entity Identifier](https://www.gleif.org/en/about-lei/introducing-the-legal-entity-identifier-lei)
...
The model has been trained on the dataset [lenu](https://huggingface.co/datasets/Sociovestix), with a focus on estonian legal entities and ELF Codes within the Jurisdiction "EE".
