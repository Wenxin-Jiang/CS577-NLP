...
```
emojis allow individuals to {a} convey the subtleties of their moods, {b} communicate nonverbally, {c} liven up their text messages, {d} explore creative expression, {e} speak in a universal language, {f} express the indescribable
```