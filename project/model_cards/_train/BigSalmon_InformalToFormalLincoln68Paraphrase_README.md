...
```
<Prefix> morning commuters are too rushed <Prefix> <Suffix> their own meal. <Suffix> <Middle> to bother to whip up <Middle>

***

<Prefix>  chancing upon a linux user <Prefix> <Suffix>  in the present day. <Suffix> <Middle>  is a rare occurrence <Middle>
```