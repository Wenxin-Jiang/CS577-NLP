...
- name: Sociovestix/lenu_NL
  ...
  - task:
    ...
    metrics:
    - type: f1
      value: 0.9829810901001113
      name: f1
    - type: f1
      value: 0.8313378032100265
      name: f1 macro
      args:
        average: macro
widget:
...
A [Dutch BERT model (BERTje)](https://huggingface.co/GroNLP/bert-base-dutch-cased) fine-tuned on dutch legal entity names (jurisdiction NL) from the Global [Legal Entity Identifier](https://www.gleif.org/en/about-lei/introducing-the-legal-entity-identifier-lei)
...
The model has been trained on the dataset [lenu](https://huggingface.co/datasets/Sociovestix), with a focus on dutch legal entities and ELF Codes within the Jurisdiction "NL".

- **Developed by:** [GLEIF](https://gleif.org) and [Sociovestix Labs](https://huggingface.co/Sociovestix)
- **License:** Creative Commons (CC0) license
- **Finetuned from model [optional]:** GroNLP/bert-base-dutch-cased
