...
* source languages: fi
* target languages: ts
*  OPUS readme: [fi-ts](https://github.com/Helsinki-NLP/OPUS-MT-train/blob/master/models/fi-ts/README.md)

*  dataset: opus
* model: transformer-align
* pre-processing: normalization + SentencePiece
* download original weights: [opus-2020-01-24.zip](https://object.pouta.csc.fi/OPUS-MT-models/fi-ts/opus-2020-01-24.zip)
