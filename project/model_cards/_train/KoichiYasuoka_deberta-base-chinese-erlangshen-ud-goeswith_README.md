...
# deberta-base-chinese-erlangshen-ud-goeswith

## Model Description

This is a DeBERTa(V2) model pre-trained on Chinese texts (both simplified and traditional) for POS-tagging and dependency-parsing (using `goeswith` for subwords), derived from [deberta-base-chinese-erlangshen-upos](https://huggingface.co/KoichiYasuoka/deberta-base-chinese-erlangshen-upos).
